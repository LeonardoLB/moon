...
public class HttpMessageNotReadableExceptionErrorAdvice {
    ...
    private List<ErrorObject> getErrors(HttpMessageNotReadableException exception) {
        try {
            JsonMappingException jsonMappingException = (JsonMappingException) exception.getCause();
            return List.of(new ErrorObject("Parse Error, wrong type sent",
            ...
            return List.of(new ErrorObject("Parse Error, wrong type sent, verify field description",
